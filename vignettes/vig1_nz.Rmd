...
In this vignette we use **BayesRates** to calculate age-specific rates and turn these age-specific rates into total divorce rates. We use data on divorce in New Zealand in New Zealand. The dataset is large and sampling errors are small.
